...
import { ArrowLeft, MapPin, Calendar, Clock, Copy, CreditCard } from "lucide-react";
                    ...
                    <CardContent className="p-6 space-y-6">
                        ...
                        <div className="pt-6 border-t border-border">
                            ...
                            <div className="space-y-4 text-muted-foreground leading-relaxed">
                                <p>
                                    Join us for an exhilarating Tech Meetup, where innovators, developers, and tech
                                    enthusiasts come together to share and explore groundbreaking ideas. This event
                                    features a comprehensive agenda, including:
                                </p>
                                <p>
                                    <strong className="text-foreground">Keynote Address:</strong> Kick off the day with an inspiring talk from a leading industry
                                    expert on the future of technology.
                                </p>
                            </div>
                        </div>
                    </CardContent>
